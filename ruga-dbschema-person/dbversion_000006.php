...
ALTER TABLE `{$person}`
    ...
    CHANGE COLUMN `prefix` `honorific_prefix` VARCHAR(255) NULL DEFAULT NULL AFTER `title`,
    ADD COLUMN `honorific_suffix` VARCHAR(255) NULL DEFAULT NULL AFTER `last_name`,
    CHANGE COLUMN `nickname` `nick_name` VARCHAR(255) NULL DEFAULT NULL AFTER `religious_name`,
